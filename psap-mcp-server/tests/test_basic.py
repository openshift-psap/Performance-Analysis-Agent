...
import psap_mcp_server.src.settings as settings_mod
...
class TestSettings:
    ...
    def test_default_settings(self):
        ...
        # Arrange
        with patch("psap_mcp_server.src.settings.Settings") as mock_settings_class:
            mock_settings = Mock()
...
class TestServer:
    ...
    def test_server_initialization(self):
        ...
        with (
            patch("psap_mcp_server.src.mcp.settings") as mock_settings,
    ...
    def test_health_endpoint(self):
        ...
        # Arrange
        with patch("psap_mcp_server.src.api.app") as mock_app:
            mock_app.routes = [Mock(path="/health")]

            # Act
            from psap_mcp_server.src.api import app
...
class TestMain:
    ...
    def test_main_module_import(self):
        ...
        import psap_mcp_server.src.main as main
...
class TestIntegration:
    ...
    def test_package_structure(self):
        ...
        import psap_mcp_server

        assert psap_mcp_server is not None

        # Test that src package exists
        import psap_mcp_server.src

        assert psap_mcp_server.src is not None

        # Test that utils package exists
        import psap_mcp_server.utils

        assert psap_mcp_server.utils is not None

    def test_version_consistency(self):
        """Test that version information is consistent."""
        try:
            from psap_mcp_server import __version__
