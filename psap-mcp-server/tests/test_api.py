...
class TestAPI:
    ...
    @patch("psap_mcp_server.src.api.settings")
    ...
    def test_app_imports(self):
        ...
        import psap_mcp_server.src.api

        assert psap_mcp_server.src.api.app is not None

    def test_server_initialization(self):
        """Test that the server is properly initialized."""
        # Arrange & Act
        from psap_mcp_server.src.api import server
    ...
    def test_transport_protocol_configuration(self, mock_settings):
        ...
        import psap_mcp_server.src.api as api_module
