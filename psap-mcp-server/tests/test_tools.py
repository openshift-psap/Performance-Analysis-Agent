...
from psap_mcp_server.src.tools.code_review_tool import generate_code_review_prompt
from psap_mcp_server.src.tools.multiply_tool import multiply_numbers
from psap_mcp_server.src.tools.redhat_logo_tool import get_redhat_logo
...
class TestMultiplyTool:
    ...
    @patch("psap_mcp_server.src.tools.multiply_tool.logger")
...
class TestRedHatLogoTool:
    ...
    @patch("psap_mcp_server.src.tools.redhat_logo_tool.Path")
