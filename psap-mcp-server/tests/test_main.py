...
from psap_mcp_server.src.main import (
...
class TestValidateConfig:
    ...
    @patch("psap_mcp_server.src.main.validate_config_func")
    @patch("psap_mcp_server.src.main.logger")
...
class TestHandleStartupError:
    ...
    @patch("psap_mcp_server.src.main.logger")
    @patch("psap_mcp_server.src.main.sys")
...
class TestMain:
    ...
    @patch("psap_mcp_server.src.main.validate_config")
    @patch("psap_mcp_server.src.main.logger")
    @patch("psap_mcp_server.src.main.uvicorn")
    def test_main_success(self, mock_uvicorn, mock_logger, mock_validate):
        ...
        with patch("psap_mcp_server.src.main.settings", mock_settings):
            # Act
            main()
    ...
    @patch("psap_mcp_server.src.main.run")
    @patch("psap_mcp_server.src.main.logger")
    @patch("psap_mcp_server.src.main.sys")
    ...
    @patch("psap_mcp_server.src.main.validate_config")
    @patch("psap_mcp_server.src.main.handle_startup_error")
...
class TestRun:
    ...
    @patch("psap_mcp_server.src.main.main")
    @patch("psap_mcp_server.src.main.logger")
    @patch("psap_mcp_server.src.main.sys")
