...
from psap_mcp_server.src.settings import validate_config as validate_config_func
from psap_mcp_server.src.tools.performance_data_loader import validate_data_availability
from psap_mcp_server.utils.pylogger import get_python_logger, get_uvicorn_log_config
...
def main() -> None:
    ...
    try:
        ...
        # Validate that performance data is available before starting the server.
        # This fails fast with clear setup instructions if neither S3 nor a local
        # CSV file is available, instead of returning cryptic errors later.
